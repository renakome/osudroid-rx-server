...
def load_blueprints():
    ...
    for root, _, files in os.walk(base_dir):
        for file in files:
            ...
            # Make import path relative to handlers directory
            import_path = "handlers" + path.replace(base_dir, "").replace(os.sep, ".")
            ...
            try:
                ...
                blueprint.prefix = path.replace(base_dir, "").replace(os.sep, "/").replace("cho", "api")
