...
pip install quart-schema~=0.18.0 argon2-cffi~=23.1.0 Werkzeug~=3.0.4
pip install discord-webhook[async]==1.3.1 geoip2==4.8.1 pytest~=8.3.4
pip install requests~=2.32.3 javaobj-py3~=0.4.4
